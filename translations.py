...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "sv": {
        ...
        "score_good":           "Bra",
        "score_needs_improvement": "Behöver förbättras",
        "score_critical":       "Kritiska brister",
        "score_label":          "Compliance-poäng",
        "metric_total":         "Totalt antal krav",
        ...
        "key_gaps":             "Viktiga brister",
        "priority_actions":     "Prioriterade åtgärder",
        "detailed_findings":    "Detaljerade fynd",
        "filter_label":         "Filtrera på status",
        "no_findings":          "Inga fynd matchar det valda filtret.",
        "finding_col":          "**Fynd**",
